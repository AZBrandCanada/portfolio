...
export default function handler(req, res) {
  ...
  // Restrict scanning to only allowed asset folders
  if (!folder || (folder !== 'landgraf' && folder !== 'ecobelle')) {
  ...
  try {
    ...
    // Convert file names to public URL paths (e.g., /landgraf/filename.png)
    const images = files
